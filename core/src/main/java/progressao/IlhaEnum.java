...
public enum IlhaEnum {
    ...
    SHELLS_TOWN(RegiaoIlha.EAST_BLUE,
            "A brisa salgada carrega o peso da opressão. Uma cidade pacata, ofuscada pela sombra de um machado tirânico. A sua jornada começa aqui."),
    ORANGE_TOWN(RegiaoIlha.EAST_BLUE,
            "Uma cidade antes próspera, agora refém de piratas e palhaços que espalham terror. O riso aqui soa como um aviso mortal."),
    ...
    WHISKY_PEAK(RegiaoIlha.PARAISO,
            "A ilha que recebe piratas com festa e vinho, mas que esconde facas e caçadores sob a luz da lua. O paraíso é apenas uma ilusão."),
    LONG_RING_LONG_LAND(RegiaoIlha.PARAISO, 
            "Uma ilha longa e esquisita, onde tudo é esticado e os Piratas Foxy desafiam os visitantes para o cruel Davy Back Fight."),
    LITTLE_GARDEN(RegiaoIlha.PARAISO,
            "O tempo parou nesta ilha pré-histórica. Dinossauros vagam e gigantes duelam em nome de uma honra que transcende séculos."),
    ...
    JAYA(RegiaoIlha.PARAISO,
            "A cidade sem lei onde sonhos são ridicularizados. Mas nas sombras de Mock Town, pistas apontam para mistérios inexplorados."),
    SKYPIEA(RegiaoIlha.PARAISO,
            "A terra sagrada além das nuvens. Onde a terra é um tesouro e um falso deus governa com relâmpagos e medo. Ouça o sino de ouro tocar."),
    ...
    SABAODY(RegiaoIlha.PARAISO,
            "Um arquipélago feito de bolhas gigantes, onde sonhos encontram a realidade cruel. Supernovas se reúnem antes de mergulhar no abismo."),
    IMPEL_DOWN(RegiaoIlha.PARAISO,
            "A grande prisão submarina. Um mergulho infernal em busca de salvação, onde cada andar é um pesadelo pior que o anterior."),
    ...
    ILHA_HOMENS_PEIXE(RegiaoIlha.NOVO_MUNDO,
            "O paraíso submarino a dez mil metros de profundidade. Uma terra dividida pelo preconceito, onde o ódio do passado ameaça o futuro."),
    PUNK_HAZARD(RegiaoIlha.NOVO_MUNDO,
            "Uma ilha dividida entre fogo escaldante e gelo cortante. O laboratório de atrocidades onde alianças perigosas são forjadas."),
    ...
    EGGHEAD(RegiaoIlha.NOVO_MUNDO,
            "A Ilha do Futuro. Um vislumbre de 500 anos à frente, onde a ciência avançada colide com os mistérios obscuros do Século Perdido."),
