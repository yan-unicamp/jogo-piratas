...
/**
 * Fábrica que define todas as 22 ilhas do Grand Line.
 *
 * Cada ilha tem:
 *  - 1-2 rodadas de capangas (dificuldade crescente)
 *  - 1 rodada final de Boss
 *
 * Escalonamento de stats por índice de ilha (0-21):
 *  Capanga HP = 60 + idx*25   | Boss HP = 250 + idx*120
 *  Capanga Defesa = 2 + idx   | Boss Defesa = 8 + idx*3
 *  Capanga Poder  = 12 + idx*5| Boss Poder  = 30 + idx*10
 */
public class ProgressaoIlhas {
    ...
    public static List<Ilha> criarTodasIlhas() {
        return Arrays.asList(
            ...
            criarSkypiea(),          //  9
            criarEniesLobby(),       // 10
            criarThrillerBark(),     // 11
            criarSabaody(),          // 12
            criarImpelDown(),        // 13
            criarMarineford(),       // 14
            criarIlhaHomeisPeixe(),  // 15
            criarPunkHazard(),       // 16
            criarDressrosa(),        // 17
            criarWholeCake(),        // 18
            criarWano(),             // 19
