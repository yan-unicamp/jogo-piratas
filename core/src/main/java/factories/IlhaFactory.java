...
public class IlhaFactory {
    ...
    public static Ilha criar(IlhaEnum ilhaEnum) {
        switch (ilhaEnum) {
            case ORANGE_TOWN: return criarOrangeTown();
            case VILA_SYRUP: return criarVilaSyrup();
            case BARATIE: return criarBaratie();
            case ARLONG_PARK: return criarArlongPark();
            case LOGUETOWN: return criarLoguetown();
            case LITTLE_GARDEN: return criarLittleGarden();
            case ILHA_DRUM: return criarIlhaDrum();
            case ALABASTA: return criarAlabasta();
            case JAYA: return criarJaya();
            case SKYPIEA: return criarSkypiea();
            case ENIES_LOBBY: return criarEniesLobby();
            case THRILLER_BARK: return criarThrillerBark();
            case SABAODY: return criarSabaody();
            case IMPEL_DOWN: return criarImpelDown();
            case MARINEFORD: return criarMarineford();
            case ILHA_HOMENS_PEIXE: return criarIlhaHomeisPeixe();
            case PUNK_HAZARD: return criarPunkHazard();
            case DRESSROSA: return criarDressrosa();
            case WHOLE_CAKE: return criarWholeCake();
            case WANO: return criarWano();
            case EGGHEAD: return criarEgghead();
            case ELBAPH: return criarElbaph();
            default: throw new IllegalArgumentException("Ilha desconhecida: " + ilhaEnum);
        }
    }
