...
public class IlhaFactory {
        ...
        public static Ilha criarGenerica(progressao.IlhasGenericasEnum genEnum) {
                ...
                List<Inimigo> inimigos = Arrays.asList(
                                PersonagemFactory.criarCapanga("Pirata", cap * 2, "inimigo_generico"),
                                PersonagemFactory.criarCapanga("Capanga", cap * 2, "inimigo_generico"));
                ...
                if (genEnum != progressao.IlhasGenericasEnum.BARCO_PIRATA_INIMIGO) {
                        List<Inimigo> inimigos2 = Arrays.asList(
                                        PersonagemFactory.criarMiniBoss("Capitao " + nome, cap * 2, "boss_generico", "Ataque Poderoso", 25 * cap));
        ...
        private static Ilha criarShellsTown() {
                return new Ilha("Shells Town", "backgrounds/shells_town.png", Arrays.asList(
                                r("BOSS - Morgan Mao de Machado!", true,
                                                PersonagemFactory.criarBoss("Morgan Mao de Machado", 0, "inimigos/bosses/morgan.png",
                ...
                return new Ilha("Orange Town", "backgrounds/orange_town.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Lugartenentes", false,
                                                PersonagemFactory.criarMiniBoss("Mohji & Richie", 0, "inimigos/minibosses/mohji.png",
                                                                "Richie Ataca!", 22),
                                                PersonagemFactory.criarMiniBoss("Cabaji", 0, "inimigos/minibosses/cabaji.png", "Acrobacia Letal",
                                                                20)),
                                r("BOSS - Buggy, o Palhaco!", true,
                                                PersonagemFactory.criarBoss("Buggy, o Palhaco", 0, "inimigos/bosses/buggy.png",
        ...
        private static Ilha criarVilaSyrup() {
                return new Ilha("Vila Syrup", "backgrounds/vila_syrup.png", Arrays.asList(
                                ...
                                r("BOSS - Capitao Kuro!", true,
                                                PersonagemFactory.criarBoss("Capitao Kuro", 1, "inimigos/bosses/kuro.png",
        ...
        private static Ilha criarBaratie() {
                return new Ilha("Baratie", "backgrounds/baratie.png", Arrays.asList(
                                r("Rodada 1 - Soldados de Krieg", false,
                                                PersonagemFactory.criarCapanga("Soldado de Krieg", 2, "inimigos/capangas/capanga_pirata.png"),
                                                PersonagemFactory.criarCapanga("Soldado de Krieg", 2, "inimigos/capangas/capanga_pirata.png")),
                                r("Rodada 2 - Pearl & Gin", false,
                                                PersonagemFactory.criarMiniBoss("Pearl", 2, "inimigos/minibosses/pearl.png", "Escudo de Fogo", 32),
                                                PersonagemFactory.criarMiniBoss("Gin", 2, "inimigos/minibosses/gin.png", "Tonfa de Ferro", 35)),
                                r("BOSS — Don Krieg!", true,
                                                PersonagemFactory.criarBoss("Don Krieg", 2, "inimigos/bosses/krieg.png",
                ...
                return new Ilha("Arlong Park", "backgrounds/arlong_park.png", Arrays.asList(
                                ...
                                r("Rodada 2 — Tripulação de Arlong", false,
                                                PersonagemFactory.criarMiniBoss("Hatchan", 3, "inimigos/minibosses/hacchi.png", "Seis Espadas",
                                                                38),
                                                PersonagemFactory.criarMiniBoss("Kuroobi", 2, "inimigos/minibosses/kuroobi.png", "Golpe de Karatê",
                                                                25),
                                                PersonagemFactory.criarMiniBoss("Chuu", 3, "inimigos/minibosses/chuu.png", "Pistola d'Agua", 30)),
                                r("BOSS - Arlong!", true,
                                                PersonagemFactory.criarBoss("Arlong", 3, "inimigos/bosses/arlong.png",
        ...
        private static Ilha criarLoguetown() {
                return new Ilha("Loguetown", "backgrounds/loguetown.png", Arrays.asList(
                                r("Rodada 1 - Patrulha da Marinha", false,
                                                PersonagemFactory.criarCapanga("Soldado da Marinha", 4, "inimigos/capangas/capanga_marinha.png"),
                                                PersonagemFactory.criarCapanga("Soldado da Marinha", 4, "inimigos/capangas/capanga_marinha.png"),
                                                PersonagemFactory.criarCapanga("Soldado da Marinha", 4, "inimigos/capangas/capanga_marinha.png")),
        ...
        private static Ilha criarLittleGarden() {
                return new Ilha("Little Garden", "backgrounds/little_garden.png", Arrays.asList(
                                r("Rodada 1 - Agentes Baroque Works", false,
                                                PersonagemFactory.criarCapanga("Agente Baroque", 5, "inimigos/capangas/capanga_pirata.png"),
                                                PersonagemFactory.criarCapanga("Agente Baroque", 5, "inimigos/capangas/capanga_pirata.png")),
                                r("Rodada 2 - Mr. 5 & Miss Valentine", false,
                                                PersonagemFactory.criarMiniBoss("Mr. 5", 5, "inimigos/minibosses/mr5.png", "Bala Explosiva", 48),
                                                PersonagemFactory.criarMiniBoss("Miss Valentine", 5, "inimigos/minibosses/mr5.png",
                                                                "Quilo-Quilo Crush", 44)),
                                r("BOSS - Mr. 3 (Galdino)!", true,
                                                PersonagemFactory.criarBoss("Mr. 3 - Galdino", 5, "inimigos/bosses/mr3.png",
        ...
        private static Ilha criarIlhaDrum() {
                return new Ilha("Ilha Drum", "backgrounds/ilha_drum.png", Arrays.asList(
                                r("Rodada 1 - Soldados de Wapol", false,
                                                PersonagemFactory.criarCapanga("Soldado de Wapol", 6, "inimigos/capangas/capanga_pirata.png"),
                                                PersonagemFactory.criarCapanga("Soldado de Wapol", 6, "inimigos/capangas/capanga_pirata.png")),
                                r("Rodada 2 - Chessmarimo", false,
                                                PersonagemFactory.criarMiniBoss("Chess", 6, "inimigos/minibosses/mr5.png", "Flecha Precisa", 52),
                                                PersonagemFactory.criarMiniBoss("Marimo", 6, "inimigos/minibosses/mr5.png", "Machado Pesado", 55)),
                                r("BOSS - Wapol!", true,
                                                PersonagemFactory.criarBoss("Wapol", 6, "inimigos/bosses/wapol.png",
                ...
                return new Ilha("Reino de Alabasta", "backgrounds/alabasta.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Mr. 4 & Mr. 2", false,
                                                PersonagemFactory.criarMiniBoss("Mr. 4", 7, "inimigos/minibosses/mr4.png", "Bola Explosiva L4",
                                                                60),
                                                PersonagemFactory.criarMiniBoss("Mr. 2 Bon Clay", 7, "inimigos/minibosses/mr2.png", "Ballet Kenpo",
                                                                58)),
                                r("Rodada 3 - Mr. 1 (Daz Bonez)", false,
                                                PersonagemFactory.criarMiniBoss("Mr. 1 - Daz Bonez", 7, "inimigos/minibosses/mr1.png",
                                                                "Laminas de Aco", 70)),
                                r("BOSS - Sir Crocodile (Mr. 0)!", true,
                                                PersonagemFactory.criarBoss("Sir Crocodile", 7, "inimigos/bosses/crocodile.png",
        ...
        private static Ilha criarJaya() {
                return new Ilha("Jaya", "backgrounds/jaya.png", Arrays.asList(
                                r("Rodada 1 - Piratas de Bellamy", false,
                                                PersonagemFactory.criarCapanga("Pirata Believer", 8, "inimigos/capangas/capanga_pirata.png"),
                                                PersonagemFactory.criarCapanga("Pirata Believer", 8, "inimigos/capangas/capanga_pirata.png")),
                                r("Rodada 2 - Bellamy, a Hiena", false,
                                                PersonagemFactory.criarMiniBoss("Bellamy", 8, "inimigos/minibosses/bellamy.png",
                                                                "Spring Hopper", 80)),
                                r("BOSS - Marshall D. Teach (Barba Negra)!", true,
                                                PersonagemFactory.criarBoss("Marshall D. Teach", 8, "inimigos/bosses/barbanegra_jaya.png",
                ...
                return new Ilha("Skypiea", "backgrounds/skypiea.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Satori & Ohm", false,
                                                PersonagemFactory.criarMiniBoss("Satori", 9, "inimigos/minibosses/satori.png", "Nuvem Explosiva",
                                                                85),
                                                PersonagemFactory.criarMiniBoss("Ohm", 9, "inimigos/minibosses/ohm.png", "Wire of Law", 90)),
                                r("BOSS - Enel!", true,
                                                PersonagemFactory.criarBoss("Enel", 9, "inimigos/bosses/enel.png",
                ...
                return new Ilha("Enies Lobby", "backgrounds/enies_lobby.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Jabura & Kaku", false,
                                                PersonagemFactory.criarMiniBoss("Jabura", 10, "inimigos/minibosses/jabura.png", "Rankyaku Lupus",
                                                                95),
                                                PersonagemFactory.criarMiniBoss("Kaku", 10, "inimigos/minibosses/kaku.png", "Pasta Buster", 100)),
                                r("BOSS - Rob Lucci!", true,
                                                PersonagemFactory.criarBoss("Rob Lucci", 10, "inimigos/bosses/rob_lucci.png",
                ...
                return new Ilha("Thriller Bark", "backgrounds/thriller_bark.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Absalom & Perona", false,
                                                PersonagemFactory.criarMiniBoss("Absalom", 11, "inimigos/minibosses/absalom.png", "Carne de Besta",
                                                                105),
                                                PersonagemFactory.criarMiniBoss("Perona", 11, "inimigos/minibosses/perona.png",
                                                                "Fantasmas Negativos", 98)),
                                r("BOSS - Gecko Moria!", true,
                                                PersonagemFactory.criarBoss("Gecko Moria", 11, "inimigos/bosses/moria.png",
        ...
        private static Ilha criarSabaody() {
                return new Ilha("Arquipelago Sabaody", "backgrounds/sabaody.png", Arrays.asList(
                                ...
                                r("BOSS - Almirante Kizaru!", true,
                                                PersonagemFactory.criarBoss("Almirante Kizaru", 12, "inimigos/bosses/kizaru.png",
        ...
        private static Ilha criarImpelDown() {
                return new Ilha("Impel Down", "backgrounds/impel_down.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Sadi-chan & Hannyabal", false,
                                                ...
                                                PersonagemFactory.criarMiniBoss("Hannyabal", 13, "inimigos/minibosses/hannyabal.png",
                                                                "Naginata Hibrida", 120)),
                                r("BOSS - Magellan!", true,
                                                PersonagemFactory.criarBoss("Magellan", 13, "inimigos/bosses/magellan.png",
        ...
        private static Ilha criarIlhaHomeisPeixe() {
                return new Ilha("Ilha dos Homens-Peixe", "backgrounds/ilha_homens_peixe.png", Arrays.asList(
                                r("Rodada 1 - Novos Homens-Peixe", false,
                                                PersonagemFactory.criarCapanga("Soldado Homem-Peixe", 15, "inimigos/capangas/capanga_pirata.png"),
                                                PersonagemFactory.criarCapanga("Soldado Homem-Peixe", 15, "inimigos/capangas/capanga_pirata.png"),
                                                PersonagemFactory.criarCapanga("Soldado Homem-Peixe", 15, "inimigos/capangas/capanga_pirata.png")),
        ...
        private static Ilha criarPunkHazard() {
                return new Ilha("Punk Hazard", "backgrounds/punk_hazard.png", Arrays.asList(
                                r("Rodada 1 - Criaturas do Lab", false,
                                                PersonagemFactory.criarCapanga("Monstro do Lab", 16, "inimigos/capangas/capanga_pirata.png"),
                                                PersonagemFactory.criarCapanga("Monstro do Lab", 16, "inimigos/capangas/capanga_pirata.png")),
                                r("Rodada 2 - Vergo & Monet", false,
                                                PersonagemFactory.criarMiniBoss("Vergo", 16, "inimigos/minibosses/vergo.png", "Haki do Peitoral",
                                                                158),
                                                PersonagemFactory.criarMiniBoss("Monet", 16, "inimigos/minibosses/monet.png", "Blizzard de Neve",
                                                                152)),
                                r("BOSS - Caesar Clown!", true,
                                                PersonagemFactory.criarBoss("Caesar Clown", 16, "inimigos/bosses/caesar.png",
                ...
                return new Ilha("Dressrosa", "backgrounds/dressrosa.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Trebol, Pica & Diamante", false,
                                                PersonagemFactory.criarMiniBoss("Trebol", 17, "inimigos/minibosses/trebol.png", "Beta Beta Mochi",
                                                                165),
                                                PersonagemFactory.criarMiniBoss("Pica", 17, "inimigos/minibosses/pica.png", "Pedra Colossal", 170),
                                                PersonagemFactory.criarMiniBoss("Diamante", 17, "inimigos/minibosses/diamante.png",
                                                                "Hira Hira Slice", 162)),
                                r("BOSS - Donquixote Doflamingo!", true,
                                                PersonagemFactory.criarBoss("Donquixote Doflamingo", 17, "inimigos/bosses/doflamingo.png",
        ...
        private static Ilha criarWholeCake() {
                return new Ilha("Whole Cake Island", "backgrounds/whole_cake.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Cracker & Smoothie", false,
                                                ...
                                                PersonagemFactory.criarMiniBoss("Smoothie", 18, "inimigos/minibosses/smoothie.png",
                                                                "Squeeze - Suco Fatal", 170)),
                                r("Rodada 3 - Charlotte Katakuri!", false,
                                                PersonagemFactory.criarBoss("Charlotte Katakuri", 18, "inimigos/bosses/katakuri.png",
                                                                "Zan Giri Mochi", 228, "Kaki no Mi - Awakening", 258)),
                                r("BOSS - Big Mom (Charlotte Linlin)!", true,
                                                PersonagemFactory.criarBoss("Big Mom", 18, "inimigos/bosses/bigmom.png",
                ...
                return new Ilha("Wano Kuni", "backgrounds/wano.png", Arrays.asList(
                                ...
                                r("Rodada 2 - Jack, Queen & King", false,
                                                ...
                                                PersonagemFactory.criarMiniBoss("Queen", 19, "inimigos/minibosses/queen.png", "Black Coffee Beam",
                                                                192),
                                                PersonagemFactory.criarMiniBoss("King", 19, "inimigos/minibosses/king.png",
                                                                "Imperial Flaming Wings", 200)),
                                r("Rodada 3 - Kurozumi Orochi", false,
                                                PersonagemFactory.criarBoss("Kurozumi Orochi", 19, "inimigos/bosses/orochi.png",
                                                                "Yamata no Orochi Bite", 210, "Veneno de Serpente",
                                                                225)),
                                r("BOSS - Kaido das Feras!", true,
                                                PersonagemFactory.criarBoss("Kaido das Feras", 19, "inimigos/bosses/kaido.png",
        ...
        private static Ilha criarEgghead() {
                return new Ilha("Egghead - Ilha do Futuro", "backgrounds/egghead.png", Arrays.asList(
                                ...
                                r("BOSS - Jaygarcia Saturn (Gorosei)!", true,
                                                PersonagemFactory.criarBoss("Jaygarcia Saturn", 20, "inimigos/bosses/saturn.png",
        ...
        private static Ilha criarElbaph() {
                return new Ilha("Elbaph - Terra dos Gigantes", "backgrounds/elbaph.png", Arrays.asList(
                                ...
                                r("BOSS FINAL - Imu-sama!", true,
                                                PersonagemFactory.criarBoss("Imu-sama", 21, "inimigos/bosses/imu.png",
